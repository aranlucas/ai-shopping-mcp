...
| Markdown shape           | `formatWeeklyDealsMarkdown` groups consecutive same-category deals under a `### Category Name` header instead of one flat list. Deal line format (`formatWeeklyDealLineMarkdown`) is unchanged.                       |
