/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be7f706d9c7aee70cad208ff51aa30f1)
// Runtime types generated with workerd@1.20260918.1 2025-03-10 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	USER_DATA_KV: KVNamespace;
	SHOPPING_DB: D1Database;
	AI: Ai;
	ASSETS: Fetcher;
	CART_OPERATIONS: DurableObjectNamespace<import("./src/server").CartOperations>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "CartOperations";
	}
